...
-- f10a için veritabanı yapısı dökülüyor
CREATE DATABASE IF NOT EXISTS `f10a` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `f10a`;

-- tablo yapısı dökülüyor f10a.futbolcu
...
-- f10a.futbolcu: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `futbolcu` DISABLE KEYS */;
/*!40000 ALTER TABLE `futbolcu` ENABLE KEYS */;

-- tablo yapısı dökülüyor f10a.mevki
CREATE TABLE IF NOT EXISTS `mevki` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tanim` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- f10a.mevki: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `mevki` DISABLE KEYS */;
/*!40000 ALTER TABLE `mevki` ENABLE KEYS */;

-- tablo yapısı dökülüyor f10a.takim
...
-- f10a.takim: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
